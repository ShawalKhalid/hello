  ...
  <div class="container grid">
    <div class="row justify-content-around">
      <div class="row col-6 pb-4 pr-1">
        <div class="dropdown">
          <a class="btn btn-light dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Select Category
            <span style="color:#f2be00;">{{ sortButton }}</span>
          </a>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item" @click="sortDate">Fiction Books</a>
            <a class="dropdown-item" @click="sortPrice" >Adventure Books</a>
            <a class="dropdown-item" @click="sortTrend">Life Books</a>
          </div>
        </div>
      </div>
          ...
          <div class="card-selector">
            <div class="card-body p-5">
              <div class="search-title">
                <h4>Collection</h4>
                <br>
                <h6 @click="sortI('table')">E-Books</h6>
                <h6 @click="sortI('lamp')">New Arrivals</h6>
                <h6 @click="sortI('chair')">Most Sold</h6>
...
export default {
  ...
  methods: {
    ...
    sortDate() {
       ...
       return this.sortButton = 'Fiction Books'
    },
    sortPrice() {
       this.cards.sort((a, b) => a.price-b.price)
       return this.sortButton = 'Adventure Books'
    },
    sortTrend() {
