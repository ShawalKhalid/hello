      ...
      <div class="row col-6 pb-4 pr-1">
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item" @click="sortDate">New Arrivals</a>
            <a class="dropdown-item" @click="sortPrice" >Popular Books</a>
            <a class="dropdown-item" @click="sortTrend">Most Sold</a>
          </div>
        </div>
      </div>
        ...
        <div class="view-button">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="MenuLink">
              <a class="dropdown-item" @click="sortI('table')">Business Books</a>
              <a class="dropdown-item" @click="sortI('lamp')">Tech Books</a>
              <a class="dropdown-item" @click="sortI('chair')">Adventure Books</a>
              <a class="dropdown-item" @click="sortI('sofa')">Fiction Books</a>
      ...
      <div class="row justify-content-center">
          ...
          <div class="card-selector">
            <div class="card-body p-5">
              <div class="search-title">
                <h4>Catagories:</h4>
                <br>
                <h6 @click="sortI('table')">Business Books</h6>
                <h6 @click="sortI('lamp')">Tech Books</h6>
                <h6 @click="sortI('chair')">Adventure Books</h6>
                <h6 @click="sortI('sofa')">Fiction Books</h6>
                <br><br><br>
                <h4 class="search-title">Filter by:</h4>
                <br>
                <div class="co">

                  <h6 @click="sortI('table')">Past 7 days</h6>
                  <h6 @click="sortI('lamp')">Past 30 days</h6>
                  <h6 @click="sortI('chair')">Below $50</h6>
                  <h6 @click="sortI('sofa')">Below $100</h6>
                </div>
               <br>
                ...
                <div class="co">
                  ...
                  <h6 @click="sortI('table')">Books (543)</h6>
                  <h6 @click="sortI('lamp')">Audio Books (987)</h6>
                </div>
              </div>
        ...
        <div class="row col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 text-center">
          ...
          <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 py-5">
            <button type="button" @click="incCardNumber" class="btn btn-outline-secondary btn-lg btn-block">Click For More Books</button>
          </div>
        </div>
      </div>
    </div>
